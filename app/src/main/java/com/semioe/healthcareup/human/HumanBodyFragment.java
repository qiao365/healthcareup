...
public class HumanBodyFragment extends Fragment implements OnClickListener,OnTouchListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			case HumanBodyActivity.WOMEN_FRONT:
				// 女性正面
				view = inflater.inflate(R.layout.human_women_front_new, null);
				break;
			case HumanBodyActivity.WOMEN_BACK:
				// 女性反面
				view = inflater.inflate(R.layout.human_women_back_new, null);
				break;
			case HumanBodyActivity.MAN_FRONT:
				// 男性正面
				view = inflater.inflate(R.layout.human_man_front_new, null);
				break;
			case HumanBodyActivity.MAN_BACK:
				// 男性反面
				view = inflater.inflate(R.layout.human_man_back_new, null);
				break;
			default:
				break;
			}
