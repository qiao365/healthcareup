package com.semioe.healthcareup.baidu;
...
import com.semioe.healthcareup.activity.MainActivity;
import com.semioe.healthcareup.activity.SplashActivity;
...
public class BaiduPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        new LoginConfig(context).setChannelId(""+channelId);
        if (errorCode == 0) {
            // 绑定成功
            Log.d(TAG, "绑定成功");
        }
